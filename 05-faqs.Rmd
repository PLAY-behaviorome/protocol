...
## FAQ about [scheduling and recruitment](#scheduling)
...
## FAQ about data collection {#faqs_collection}
...
### Five-minute Structured Play {#faqs_structured_play}
...
### Questionnaires {#faqs_questionnaires}
...
- Say <say>"For this part we are going ask some questions just to [CHILD'S] mom. For consistency, since sometimes other individuals aren't present or part of the family, we want just the mother to answer the questions."</say>
...
### House Walkthrough {#faqs_walkthrough}
