...
### English instructions {- #english_instructions}

(See video at the end of the script)^[Videos used in this section may be found at <https://nyu.databrary.org/volume/876/slot/35422/->].
...
- → *If yes: **end call**.* <say>In this study, we want to observe you and [CHILD] when it's only the two of you in the home. Is it possible to arrange a time when only you and [CHILD] are home for two hours?</say>
- → *If no: continue*
...
- → *If yes: **end call** * <say>Currently, we are only enrolling families who are symptom-free and had no interaction with anyone COVID positive. But is it okay, if we call you for this study again in a few months?</say>
- → *If no: continue* 
...
#### Video example {- #recruiting_call_video} 
...
### Spanish instructions {- #spanish_instructions}
...
#### Video example {- #recruiting_call_video_spanish}
...
##### Video example {- #voicemail_video_spanish}
