...
2. Import the XLSX files and export them as CSVs to a separate local directory that is **not** synced to GitHub. See <https://play-behaviorome.github.io/kobotoolbox/02-save_raw_csvs.html> for more details. 
...
Once these steps are completed, it is possible to render a document that provides simple visualizations of the survey data, as in <https://play-behaviorome.github.io/kobotoolbox/release_1.0_survey_report.html>. 
As of 2022-03-18, this report contains information that links sessions to specific data collection sites, so the team is not sharing this publicly.
